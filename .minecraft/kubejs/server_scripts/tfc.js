...
onEvent('recipes', event => {
  ...
  event.remove({ output: '2x tfc:fire_clay' })
  event.recipes.createMixing('tfc:fire_clay', ['kubejs:underclay_ball', 'tfc:powder/kaolinite', 'tfc:powder/kaolinite', 'tfc:powder/kaolinite', 'tfc:powder/kaolinite', 'mekanism:dust_quartz', 'tfc:powder/sulfur', Fluid.of('minecraft:lava', 10)]).superheated()
  ...
  event.recipes.tfc.blast_furnace(Fluid.of('tfc_metallum:metal/aluminum', 1), Fluid.of('kubejs:cast_aluminum', 1), 'kubejs:powder/cryolite')
...
onEvent('server.datapack.first', event => {
  ...
  event.addTFCMetal('kubejs:pitch', 240, 0.01, 'thermal:rosin', 'minecraft:structure_void')
