...
onEvent('recipes', event => {
  ...
  event.recipes.tfc.barrel_instant([Fluid.of('kubejs:ashwater', 250)], 'kubejs:powder/fly_ash', Fluid.of('minecraft:water', 250))
  event.recipes.createMixing(Fluid.of('kubejs:ashwater', 250), ['kubejs:powder/fly_ash', Fluid.of('minecraft:water', 250)])
  event.recipes.createFilling('kubejs:brick/unfired_ash_brick', ['tfc:ceramic/unfired_brick', Fluid.of('kubejs:ashwater', 250)])
  ...
  event.recipes.tfc.barrel_instant([Fluid.of('kubejs:clinkerwater', 250)], 'kubejs:powder/coke_oven', Fluid.of('minecraft:water', 250))
  event.recipes.createMixing(Fluid.of('kubejs:clinkerwater', 250), ['kubejs:powder/coke_oven', Fluid.of('minecraft:water', 250)])
  event.recipes.createFilling('kubejs:brick/unfired_coke_oven_brick', ['tfc:ceramic/unfired_brick', Fluid.of('kubejs:clinkerwater', 250)])
  ...
  event.recipes.tfc.barrel_instant([Fluid.of('kubejs:cinderwater', 250)], 'kubejs:powder/bloomery', Fluid.of('minecraft:water', 250))
