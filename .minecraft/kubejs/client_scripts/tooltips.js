...
onEvent('item.tooltip', event => {
  ...
  function anvilTooltip(mod, metal) {
  ...
  global.tier1MetalTypes.forEach(i => anvilTooltip('tfc', i));
  global.tier1MetallumMetalTypes.forEach(i => anvilTooltip('tfc_metallum', i));
  ...
  function barrelsTooltip(barrel) {
    event.addAdvanced(barrel, (item, _, tooltip) => {
      new ItemDescription(Palette.Yellow)
  ...
  global.tfcWoodTypes.forEach(i => barrelsTooltip(`tfc:wood/barrel/${i}`));
